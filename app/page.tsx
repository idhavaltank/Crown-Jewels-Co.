...
// 3. Constants or config
import { PRIVATE_NAVIGATION } from "@/constants";

// Section-wise functional components
  ...
  <section className="brand-legacy">
    ...
    <div className="legacy-text">
      ...
      <p>
        ...
        stones into stories you can wear. Discover the rich heritage behind each
        masterpiece.
      </p>
...
const SignaturePieces = () => (
  <section className="signature-pieces">
    <h2>Upcoming Signature Pieces</h2>
...
const RoyalMoments = () => (
  <section className="royal-moments">
    ...
    {/* Optionally add Instagram embed or customer spotlight */}
  </section>
);
...
// Main Home component assembling all sections
const Home = () => (
  <>
    <HeroSection />
    <BrandLegacy />
